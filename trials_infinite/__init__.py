...
Trials are generated on demand in infinite sequence.
...
class Main(Page):
    ...
    def handle_iteration(player: Player, data: dict):
        """move to next iteration and generate new trial"""
        if player.current_iter > 0:
        ...
        trial = Trial.generate(player, player.current_iter)
